class Translations {
  static final Map<String, Map<String, String>> _data = {
    'en': {
      ...
      'payment_cycle_reminder_msg': 'Next payment processing will initiate in {days} days (on {date}).',
      'payment_ready_msg': '🎉 Payment processing is scheduled for TODAY ({date}). Nestlé will credit your account soon.',
    ...
    'si': {
      ...
      'payment_cycle_reminder_msg': 'මීළඟ ගෙවීම් සැකසීම තව දින {days} කින් ({date}) ආරම්භ වේ.',
      'payment_ready_msg': '🎉 ගෙවීම් සැකසීම අද දිනට ({date}) නියමිතයි. ඔබේ ගිණුමට ඉක්මනින් ක්‍රෙඩිට් වේ.',
    ...
    'ta': {
      ...
      'payment_cycle_reminder_msg': 'அடுத்த கொடுப்பனவு செயலாக்கம் {days} நாட்களில் ({date}) தொடங்கும்.',
      'payment_ready_msg': '🎉 கொடுப்பனவு செயலாக்கம் இன்றே ({date}) நடைடெறும். உங்கள் கணக்கில் விரைவில் வரவு வைக்கப்படும்.',
