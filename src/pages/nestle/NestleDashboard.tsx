...
import { Milk, Users, Truck, DollarSign } from 'lucide-react';
  ...
  useEffect(() => {
    Promise.all([
      ...
      setStats({
        ...
        totalQty: cols.reduce((s, c) => s + parseNumber(c.quantity), 0),
        dispatches: dispatches.length,
        totalPayments: payments.reduce((s, p) => s + parseNumber(p.amount), 0),
        nestleOfficers: officers.length,
      });
    });
  }, []);
