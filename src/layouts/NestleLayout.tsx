...
import { Milk, Users, Truck, DollarSign, BarChart3, LogOut, Menu, Settings, Building2, HelpCircle, TrendingUp, BookOpen } from 'lucide-react';
...
const navItems = [
  ...
  { title: 'Recommendations', path: '/nestle/recommendations', icon: BookOpen },
